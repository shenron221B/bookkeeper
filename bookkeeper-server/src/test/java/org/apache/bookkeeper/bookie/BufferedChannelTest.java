...
public class BufferedChannelTest {
    ...
    public void testRead_NullDestination() throws IOException {
        bufferedChannel.read(null, 0L, 10);
    }

    @Test(expected = IOException.class)
    public void testRead_NegativePosition() throws IOException {
    ...
    @Test
    public void testRead_DestinationCapacityInsufficient() throws IOException {
    ...
    @Test
    public void testRead_FromDisk() throws IOException {
        int length = 5;
    ...
    @Test
    public void testRead_FromWriteBuffer() throws IOException {
    ...
    @Test
    public void testWrite_WithinCapacity() throws IOException {
    ...
    @Test
    public void testWrite_ExceedingCapacity_TriggersFlush() throws IOException {
    ...
    @Test
    public void testRead_Overlap_DiskAndBuffer() throws IOException {
